...
import com.example.firstDemo.Repository.EmailRepository;
import com.jfplugin.mail.core.JavaMailSender;

import com.jfplugin.mail.core.MimeMessageHelper;
import com.jfplugin.mail.core.SimpleMailMessage;
...
public class EmailService implements EmailRepository {
    ...
    public String sendMailWithAttachmentToMany(EmailDetails emailDetails) {
        ...
        try {
            ...
            mimeMessageHelper.addAttachment(file.getFilename(), (DataSource) file);
